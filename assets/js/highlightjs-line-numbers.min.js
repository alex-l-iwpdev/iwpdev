! function (e, n) {
    ...
    function r(e) {
        for (var n = e;
            "TABLE" !== n.nodeName;) n = n.parentNode;
        return n
    }

    function o(e) {
        for (var n = e.toString(), t = e.anchorNode;
            "TD" !== t.nodeName;) t = t.parentNode;
        for (var o = e.focusNode;
            "TD" !== o.nodeName;) o = o.parentNode;
        var a = parseInt(t.dataset.lineNumber),
    ...
    function l(t) {
        try {
            var r = n.querySelectorAll(".code-body");
